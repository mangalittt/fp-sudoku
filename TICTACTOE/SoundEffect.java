...
public enum SoundEffect {
   EAT_FOOD("Audio/mouse-click-117076.wav"),
   EXPLODE("Audio/dead-8bit-41400.wav"),
   DIE("Audio/wah-wah-sad-trombone-6347.wav"),
   DRAW("Audio/ufo-sound-effect-240256.wav");
   ...
   public static void preload() {
      for (SoundEffect effect : SoundEffect.values()) {
          effect.clip.setFramePosition(0); // Siapkan semua clip
      }
  }
}
